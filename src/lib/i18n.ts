  ...
  zh: {
    ...
    quilts: {
      ...
      form: {
        ...
        packagingInfoPlaceholder: '例如：真空袋、收纳箱',
    ...
    reports: {
      ...
      import: {
        ...
        uploadDescription: '选择或拖放包含被子数据的Excel文件',
        dropFile: '将Excel文件拖放到这里',
        orClickToBrowse: '或点击浏览并选择文件',
        selectFile: '选择文件',
        uploading: '上传中...',
        ...
        expectedColumns: '预期列',
        columnDescription:
          '系统将自动检测并映射Excel文件中的列。常见列包括：编号、名称、季节、颜色、品牌、位置等。',
        importTips: '导入提示',
        tip1: '确保您的Excel文件每行都有列名标题',
        tip2: '每床被子的编号应该是唯一的',
      },
      quickActions: '快速操作',
  ...
  en: {
    ...
    quilts: {
      ...
      form: {
        ...
        locationPlaceholder: 'Master bedroom closet',
        packagingInfoPlaceholder: 'e.g., Vacuum bag, Storage box',
    ...
    reports: {
      ...
      import: {
        ...
        uploadDescription: 'Select or drag and drop your Excel file containing quilt data',
        dropFile: 'Drop your Excel file here',
        orClickToBrowse: 'or click to browse and select a file',
        ...
        perFile: '10MB per file',
        expectedColumns: 'Expected columns',
        columnDescription:
          'The system will automatically detect and map columns from your Excel file. Common columns include: Item Number, Name, Season, Color, Brand, Location, etc.',
        importTips: 'Import Tips',
        tip1: 'Make sure your Excel file has a header row with column names',
        tip2: 'Item numbers should be unique for each quilt',
      },
