...
// Dynamic imports for large seasonal components
const SeasonalRecommendations = dynamic(
  () =>
    import('@/components/seasonal/SeasonalRecommendations').then(mod => ({
      default: mod.SeasonalRecommendations,
    })),
  {
    loading: () => <Loading text="Loading recommendations..." />,
    ssr: false,
  }
);

const WeatherBasedSuggestions = dynamic(
  () =>
    import('@/components/seasonal/WeatherBasedSuggestions').then(mod => ({
      default: mod.WeatherBasedSuggestions,
    })),
  {
    loading: () => <Loading text="Loading weather analysis..." />,
    ssr: false,
  }
);
import {
...
export default function SeasonalIntelligencePage() {
  ...
  const availableCurrentSeasonQuilts = currentSeasonQuilts.filter(
    q => q.currentStatus === 'AVAILABLE'
  );
  ...
  const SeasonIcon =
    currentSeason === 'WINTER' ? Snowflake : currentSeason === 'SUMMER' ? Sun : Leaf;

  const seasonName =
    currentSeason === 'WINTER' ? 'Winter' : currentSeason === 'SUMMER' ? 'Summer' : 'Spring/Autumn';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">
            Smart recommendations and insights for optimal quilt selection
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-3xl font-bold text-green-600">
                {availableCurrentSeasonQuilts.length}
              </div>
            ...
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <div className="text-3xl font-bold text-purple-600">
                {currentSeasonQuilts.length > 0
                  ? Math.round(
                      ((currentSeasonQuilts.length - availableCurrentSeasonQuilts.length) /
                        currentSeasonQuilts.length) *
                        100
                    )
                  : 0}
                %
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">
                    {seasonalStats.springAutumnQuilts} quilts
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">
                    {seasonalStats.totalUsagePeriods} periods
                  </div>
                </div>
              </div>
      ...
      {quilts.length === 0 ? (
        ...
        <Tabs defaultValue="recommendations" className="space-y-6">
          ...
          <TabsContent value="weather">
            <WeatherBasedSuggestions quilts={quilts} location="Your Location" />
          </TabsContent>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-800">
                          Based on your usage patterns, you tend to prefer heavier quilts during
                          transitional seasons. Consider having a medium-weight option ready for
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-800">
                          Your satisfaction ratings are highest when using quilts in the 18-22°C
                          range. Consider this when selecting quilts for different rooms or seasons.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-purple-800">
                          Some of your quilts are underutilized. Consider rotating your collection
                          more frequently or storing less-used quilts to make room for new
                          additions.
                        </p>
                      </div>
                    </div>
