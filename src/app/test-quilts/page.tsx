...
export default function TestQuiltsPage() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-4">
        <p>
          <strong>Total Quilts:</strong> {data?.total || 0}
        </p>
        <p>
          <strong>Quilts Array Length:</strong> {data?.quilts?.length || 0}
        </p>
      </div>
        ...
        <div>
          ...
          {data.quilts.slice(0, 3).map((quilt: any, index: number) => (
            <div key={quilt.id || index} className="border p-4 mb-2 rounded">
              <p>
                <strong>ID:</strong> {quilt.id}
              </p>
              <p>
                <strong>Name:</strong> {quilt.name}
              </p>
              <p>
                <strong>Item Number:</strong> {quilt.itemNumber}
              </p>
              <p>
                <strong>Season:</strong> {quilt.season}
              </p>
              <p>
                <strong>Dimensions:</strong> {quilt.lengthCm}×{quilt.widthCm}cm
              </p>
              <p>
                <strong>Weight:</strong> {quilt.weightGrams}g
              </p>
            </div>
          ))}
        </div>
